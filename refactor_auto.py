...
def _analyze_file_for_split(
    ...
    if len(classes) > max_classes:
        for cls_node in classes:
            ...
            # 分析这个类用到了哪些 import
            needed = _find_needed_imports(cls_node, import_nodes, lines)
    ...
    if len(functions) > max_funcs or total_lines > max_file_lines:
        ...
        ungrouped: list[ast.FunctionDef] = []
        ...
        for prefix, group in prefix_groups.items():
            ...
            for func_node in group:
                ...
                needed = _find_needed_imports(func_node, import_nodes, lines)
