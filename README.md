# PyRefactor — AI Code Review Tools Built for Humans

Static analysis, auto-refactoring, structural diff, and MCP server for AI Code Review.

> **Vision:** In the age of AI, the sheer volume of code generated by artificial intelligence has made human review increasingly difficult. Consequently, many have abandoned the review process entirely—much like projects such as OpenClaw, which see thousands of commits daily; with such an overwhelming volume, there is simply no one left to manually read or review the code. The core objective of this project, therefore, is to accelerate the review of AI-generated code by optimizing focus—directing attention to the fewest possible areas to review the greatest possible amount of content. This is the genesis of this project.
